(function ($, window) {
  ...
  var default_meow_area,
    ...
    Meow = function (options) {
      ...
      if (options.remove && options.timestamp) {
        console.log("REMOVE");
        return false;
      }
      ...
      if (
        typeof default_meow_area === "undefined" &&
      ...
      if (typeof options.message === "string") {
        ...
        if (
          ...
          typeof options.message.attr("title") === "string"
        ) {
      ...
      var content_div = $(window.document.createElement("div"))
        .addClass("content")
        .html(this.message);
      ...
      if (typeof this.title === "string") {
        // changed from original - used .text instead of .html
        this.manifest
          .find(".inner .content")
          .prepend($(window.document.createElement("h1")).html(this.title));
      }

      // Add icon if it's defined
      if (typeof that.icon === "string") {
        if (that.icon.indexOf("fa-") > -1) {
          this.manifest.find(".inner").prepend(
            $(window.document.createElement("div"))
              .addClass("icon")
              .html(
                $(window.document.createElement("span")).attr(
                  "class",
                  this.icon,
                ),
              ),
